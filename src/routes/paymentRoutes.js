...
const {createPayment, getAllPayments, getPaymentById, updatePayment, deletePayment, getAllPaymentByUserId} = require('../controller/paymentController');
...
router.get('/user/:id',verifyToken, getAllPaymentByUserId);
